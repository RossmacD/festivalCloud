    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        if ($auth->isAuthenticated()) {
            ...
            echo '<a class="nav-link" href="https://ryangraves08-is-my-gmail-password.auth.us-east-1.amazoncognito.com/login?client_id=n2lj9229idf26f6k7sgfbbtoq&response_type=token&scope=aws.cognito.signin.user.admin+email+openid+phone+profile&redirect_uri=https://festivalcloud.rossmacd.com/secure_page.php">Login / Register</a>';
        }
        ?>
      </div>
    </div>
